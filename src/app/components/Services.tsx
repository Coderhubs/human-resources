          ...
          <div className="flex flex-wrap text-center justify-center">
            <div className="p-4 md:w-1/4 sm:w-1/2">
              <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                ...
                <h2 className="title-font font-regular text-2xl text-gray-900">Talent Acquisition</h2>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2">
              <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                ...
                <h2 className="title-font font-regular text-2xl text-gray-900">Performance Management</h2>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2">
              <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                ...
                <h2 className="title-font font-regular text-2xl text-gray-900">Employee Training & Development</h2>
              </div>
            </div>
          </div>
        </div>
